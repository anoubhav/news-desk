  ...
  liveAvatar: {
    ...
    anchors: {
      neutral: {
        ...
        voiceId: process.env.LIVEAVATAR_NEUTRAL_VOICE_ID || "4f3b1e99-b580-4f05-9b67-a5f585be0232",
      ...
      left: {
        ...
        voiceId: process.env.LIVEAVATAR_LEFT_VOICE_ID || "e948b062-7dce-4f2b-bcf6-98bd3511106b",
      ...
      right: {
        ...
        voiceId: process.env.LIVEAVATAR_RIGHT_VOICE_ID || "b952f553-f7f3-4e52-8625-86b4c415384f",
